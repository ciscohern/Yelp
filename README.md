...
1. Allowing the user to let the app use their location
2. Constraints
...
<img src='https://github.com/ciscohern/Yelp/blob/master/Yelp Demo.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
